...
const Task = ({ reactKey, task, taskClick }) => {
    return (
        <div data-key={reactKey} className='mt3 mb3 pa2 pv1 mw7 bb b--silver flex flex-row justify-start shadow-hover' style={{ 'overflow-wrap': 'break-word', cursor: 'default' }}>
